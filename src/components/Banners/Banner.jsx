...
const Banner = () => {
  return (
    <section className="bg-secondary/10">
      <div className="container grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 py-5 ">
        {/* Banner Image  */}
        ...
        <div className="flex flex-col justify-center">
          <div className=" text-center md:text-left space-y-4 lg:max-w-[400px]">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
            Experience the pure, wholesome goodness straight from farm to table, ensuring quality you can trust in every bite.
            </motion.p>
            <motion.div
              variants={FadeUp(1.1)}
              initial="hidden"
