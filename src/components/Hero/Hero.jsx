    ...
    <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[550px]  relative">
      ...
      <div className=" flex flex-col justify-center py-14 md:py-0 relative z-10">
        <div className="text-center md:text-left space-y-6 lg:max-w-[400px]">
          ...
          initial= "hidden"
          animate = "visible" 
          className="text-2xl tracking-wide">Order Now For Fresh Healthy Fruits</motion.p>
          <motion.p 
          variants={FadeRight(1.2)}
          initial= "hidden"
          animate = "visible" 
          className="text-gray-400">Healthy and yummy food for fresh morning breakfast. Eat Daily for good Health and mind Order now to get 20% off on your first order.</motion.p>
          {/* Button Section  */}
          <motion.div 
